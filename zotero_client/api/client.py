...
class ZoteroClient:
    ...
    @staticmethod
    def _build_item_search_params(q: Optional[str] = None, qmode: Optional[str] = None, item_type: Optional[str] = None, tag: Optional[str] = None, include_trashed: Optional[bool] = None) -> Dict[str, Any]:
        """Build the query-string params shared by get_items() and get_collection_items()."""
        params = {}
        if q:
            params['q'] = q
        if qmode:
    ...
    def get_items(self, limit: Optional[int] = None, q: Optional[str] = None, qmode: Optional[str] = None, item_type: Optional[str] = None, tag: Optional[str] = None, include_trashed: Optional[bool] = None) -> List[Item]:
        ...
        params = self._build_item_search_params(q, qmode, item_type, tag, include_trashed)
